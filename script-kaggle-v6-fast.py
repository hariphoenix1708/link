...
# Hugging Face large-file downloads are more stable through the hub client
# than aria2 in Kaggle notebooks, especially for xet-backed files.
...
if INSTALL_DEPS:
    ...
    subprocess.run(["uv", "pip", "install", "--system", "-q", "hf_xet"])
