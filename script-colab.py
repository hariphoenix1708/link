...
if not os.path.exists(WORKSPACE):
    ...
    subprocess.run(["git", "clone", "--config", "core.filemode=false", "-b", "py3.12",
...
if INSTALL_DEPS:
    ...
    urllib.request.urlretrieve(
        ...
        "https://github.com/lllyasviel/stable-diffusion-webui-forge/raw/refs/heads/py3.12/requirements_versions.txt"
        "requirements_versions.txt"
    )
    '''
    url = "https://raw.githubusercontent.com/lllyasviel/stable-diffusion-webui-forge/py3.12/requirements_versions.txt"
    outfile = "requirements_versions.txt"
...
# Launch WebUI
LAUNCH_CMD = f"python launch.py {share} --api --listen --enable-insecure-extension-access {auth} --disable-console-progressbars --no-hashing --precision autocast --upcast-sampling"
